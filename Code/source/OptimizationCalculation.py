...
class OptimizationCalculation(Calculation):
    ...
    def GenerateSection(self, ECurveF, sectionNum):
        for EWF in np.arange(self.CDDRange["EWidthF"][sectionNum][0], self.CDDRange["EWidthF"][sectionNum][1],
                             self.CDDRange["Interval"]):
            for EDF in np.arange(self.CDDRange["EDepthF"][sectionNum][0], self.CDDRange["EDepthF"][sectionNum][1],
                                 self.CDDRange["Interval"]):
